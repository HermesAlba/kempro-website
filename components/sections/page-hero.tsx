...
export function PageHero({
  ...
  return (
    ...
    <section
      className={`relative -mt-[54px] overflow-hidden border-b border-neutral-200 ${gradient ? "bg-white" : "bg-primary-50/50"} pb-16 pt-[118px] sm:pb-24 sm:pt-[150px] lg:-mt-[134px] lg:pt-[230px]`}
    >
      {gradient && (
        <div
          aria-hidden="true"
