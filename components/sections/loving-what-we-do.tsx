...
// - right panel: dark background; heading 40px/800/uppercase (44px line-
//   height); 20px gap to subtitle; subtitle 16px/400 (24px line-height);
//   35px gap to button; button solid-fill, 18px/30px padding, no radius,
//   15px/600/uppercase
//
  ...
  return (
    <section className="bg-neutral-900">
      <div className="grid lg:grid-cols-2">
        ...
        <div
          aria-hidden="true"
          className="aspect-[6/5] w-full bg-neutral-700 lg:aspect-auto lg:min-h-[470px]"
        />
        <div className="flex flex-col justify-center px-6 py-16 sm:px-10 sm:py-20 lg:px-[50px]">
          <h2 className="text-[32px] font-extrabold uppercase leading-[1.1] text-white sm:text-[40px]">
            {t("title")}
          </h2>
          <p className="mt-5 max-w-[440px] text-[16px] leading-[24px] text-white">
            {t("subtitle")}
          </p>
