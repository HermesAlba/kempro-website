  ...
  return (
    ...
    <section className="relative -mt-[81px] flex flex-1 items-start bg-black pt-[81px] lg:-mt-[207px] lg:pt-[207px]">
      {/* Flat solid black (bg-black on the section above), no pattern —
          per request. Ends exactly at this section's own bottom (the
          carousel right after it stays fully white — see the 1cm black
          spacer added *after* the carousel instead, in app/[locale]/page.tsx). */}
