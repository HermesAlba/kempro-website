...
// font-sans (Montserrat) explicit here: <body>'s document default is now
// font-poppins (see app/[locale]/layout.tsx), matching KR's own split of
// Poppins for body copy vs. Montserrat for nav/buttons/UI chrome.
export const ctaButtonClasses =
  "inline-flex items-center justify-center gap-2 rounded-[6px] bg-neutral-900 font-sans text-[13px] tracking-[-0.02em] text-white transition-colors hover:bg-primary-700";
