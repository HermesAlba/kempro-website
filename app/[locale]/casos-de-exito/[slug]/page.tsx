  ...
  return (
    <article className="relative overflow-hidden bg-slate-50 lg:min-h-screen">
      ...
      {/* Desktop-only photo: absolutely positioned against <article> itself
          ...
          at 96dpi) alone gives the 1cm gap; the lg header's own 90px (see
          HEADER_OFFSET in components/layout/header.tsx) must NOT be added
          again here. Height is 100vh minus that same 90px header, minus
      ...
      <div
        data-hero-photo
        className="pointer-events-none absolute right-[81px] top-[38px] hidden h-[calc(100vh-90px-76px)] w-[380px] max-w-full overflow-hidden rounded-2xl lg:right-[105px] lg:block"
      >
