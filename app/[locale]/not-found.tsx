...
export default function NotFound() {
  ...
  return (
    ...
    // instead of stopping under the header. 214px/245px = the 176px/207px
    ...
    // that amount.
    <section
      className="relative -mt-[176px] flex min-h-[calc(100vh-214px)] items-center overflow-hidden pt-[176px] lg:-mt-[207px] lg:min-h-[calc(100vh-245px)] lg:pt-[207px]"
    >
