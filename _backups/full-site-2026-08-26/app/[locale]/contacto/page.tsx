...
export default async function ContactPage({
  ...
  return (
    ...
    <div className="relative -mt-[54px] flex flex-col overflow-hidden bg-white pt-[54px] md:min-h-screen md:flex-row lg:-mt-[70px] lg:pt-[70px]">
      ...
      {/* FormSide — three stacked full-bleed bands spanning the column's
          ...
          correction this column's box would still start at y=54/70px, not
