...
const data: {
  ...
  },
  {
    ...
    author: "Marketing Kempro",
    title: {
      es: "El \"Corporate Brain\" que armamos con SharePoint y Copilot Chat, sin licencias adicionales",
      en: "The \"Corporate Brain\" we built with SharePoint and Copilot Chat, no additional licenses",
    },
    excerpt: {
  ...
  },
  {
    ...
    author: "Marketing Kempro",
    title: {
      es: "El sitio web de Kempro, diseñado y construido 100% con IA",
      en: "The Kempro website, designed and built 100% with AI",
    },
    excerpt: {
  ...
  },
  {
    ...
    readingTime: { es: "4 min de lectura", en: "4 min read" },
    content: {
      es: [
        {
          type: "paragraph",
          text: "Hace unos días, el creador de contenido español Gustavo Entrala publicó un video mostrando en vivo la nueva versión de escritorio de ChatGPT, comparándola con saltos tecnológicos como la llegada del iPhone — y señalando que está inspirada en un producto que Anthropic lanzó meses antes: Claude Cowork. Vale la pena comparar punto por punto qué tan distinto es realmente de lo que Cowork ya permite hacer.",
        },
        { type: "heading", text: "Voz y control del ordenador" },
        {
          type: "paragraph",
          text: 'En la demo, Entrala le pide a ChatGPT por voz que revise un correo y deje una respuesta lista en Gmail sin tocar el teclado. Cowork no tiene todavía un modo de voz nativo equivalente, pero resuelve el control del ordenador con un sistema de permisos por niveles en vez de acceso total: un navegador se puede ver pero no hacer clic sin habilitarlo, una terminal ejecuta comandos puntuales sin recibir pulsaciones libres, y cualquier acción irreversible requiere confirmación explícita antes de ocurrir.',
        },
        { type: "heading", text: "Correos, tareas recurrentes y documentos" },
        {
          type: "paragraph",
          text: "Dejar un correo listo como borrador, programar un informe diario de noticias o generar una presentación a partir de contenido ya investigado — todo lo que muestra la demo de ChatGPT tiene un equivalente directo en Cowork: su conector de Gmail deja las respuestas como borrador salvo confirmación explícita, sus tareas programadas nativas cubren tanto recordatorios puntuales como rutinas recurrentes, y genera documentos de Word, PowerPoint, Excel y PDF reales — no texto plano dentro del chat.",
        },
        { type: "heading", text: "Análisis de datos y lo que Cowork aún no hace" },
        {
          type: "paragraph",
          text: "Conectar una fuente de datos (analítica, un CRM, una base de datos) y hacerle preguntas de negocio directas es el mismo principio detrás de los conectores de Cowork. Donde sí hay una diferencia real es en el control creativo avanzado: el ajuste de color dentro de Final Cut Pro que muestra la demo es un terreno donde Cowork es más conservador, priorizando navegación web y flujos de oficina sobre edición profesional.",
        },
        { type: "heading", text: "La diferencia de fondo" },
        {
          type: "paragraph",
          text: "Más allá de la lista de funciones, la diferencia es filosófica. Entrala plantea el salto de ChatGPT como una cuestión de capacidad; Cowork nació resolviendo primero qué tan seguro es delegarle estas tareas a una IA, construyendo permiso, confirmación y límites desde el diseño. En Kempro nos encontramos con esa misma pregunta cada vez que asesoramos a un cliente: no es solo qué tan potente es la tecnología, sino qué tan bien su modelo de permisos encaja con el nivel de gobierno que la organización realmente tiene.",
        },
        {
          type: "paragraph",
          text: 'Ambos siguen un modelo de suscripción por niveles — vale la pena confirmar precios vigentes en el sitio de cada compañía. Pero el video de Entrala confirma algo que ya intuíamos: el "chat que responde preguntas" quedó atrás. La conversación ahora es sobre cuánto control le damos a un agente sobre nuestras herramientas de trabajo.',
        },
      ],
      en: [
        {
          type: "paragraph",
          text: "A few days ago, Spanish content creator Gustavo Entrala published a video demoing the new ChatGPT desktop version live, comparing it to leaps like the arrival of the iPhone — and pointing out that it's inspired by a product Anthropic shipped months earlier: Claude Cowork. It's worth a point-by-point comparison of how different it really is from what Cowork already does.",
        },
        { type: "heading", text: "Voice and computer control" },
        {
          type: "paragraph",
          text: "In the demo, Entrala asks ChatGPT by voice to review an email and leave a ready-to-send reply in Gmail without touching the keyboard. Cowork doesn't yet have an equivalent native voice mode, but it handles computer control with tiered permissions instead of full access: a browser can be viewed but not clicked without explicitly enabling it, a terminal runs specific commands without receiving free-form keystrokes, and any irreversible action requires explicit confirmation before it happens.",
        },
        { type: "heading", text: "Emails, recurring tasks, and documents" },
        {
          type: "paragraph",
          text: "Leaving an email ready as a draft, scheduling a daily news digest, or generating a presentation from already-researched content — everything the ChatGPT demo shows has a direct equivalent in Cowork: its Gmail connector leaves replies as drafts pending explicit approval, its native scheduled tasks cover both one-off reminders and recurring routines, and it generates real Word, PowerPoint, Excel, and PDF files — not plain text inside the chat.",
        },
        { type: "heading", text: "Data analysis and what Cowork doesn't do yet" },
        {
          type: "paragraph",
          text: "Connecting a data source (analytics, a CRM, a database) and asking it direct business questions is the same principle behind Cowork's connectors. Where there's a real gap is advanced creative control: the color grading inside Final Cut Pro shown in the demo is territory where Cowork is more conservative, prioritizing web browsing and office workflows over professional editing.",
        },
        { type: "heading", text: "The underlying difference" },
        {
          type: "paragraph",
          text: "Beyond the feature checklist, the difference is philosophical. Entrala frames ChatGPT's leap as a matter of capability; Cowork was built by first solving how safe it is to hand these tasks to an AI, building permission, confirmation, and limits into the design from the start. At Kempro we run into that same question every time we advise a client: it's never just how powerful the technology is, but how well its permission model fits the level of governance the organization actually has.",
        },
        {
          type: "paragraph",
          text: "Both follow a tiered subscription model — it's worth confirming current pricing on each company's site. But Entrala's video confirms something we probably already suspected: the \"chatbot that answers questions\" is behind us. The conversation now is about how much control we hand an agent over our work tools.",
        },
      ],
    },
  },
